  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <button className="mt-3" type="button" onClick={handleAddSkill}>
          Add New Skill
        </button>
      </div>
      <div>
        <div className="text-white w-fit mt-10 mb-3 flex items-center">
          <h1>Projects</h1>
          <sup
            title="Choose the stack icon for each project in portfolio.json"
        ...
        <div id="accordionExample">
          {projects.map((project, index) => (
            <div class="rounded-t-lg bg-slate-800 mb-2">
              ...
              <div
            key={index}
            className="p-3 pl-5 dark:bg-slate-700 rounded-lg ring-1 ring-slate-900/5 shadow-xl"
          >
            <div className={labelTextInputWrapper}>
              <button
